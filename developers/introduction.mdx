...
- **[Checkouts](/checkouts/introduction)** — Hosted payment pages for Argentina, Brazil, Chile, and Bolivia (create, validate, reconcile in the dashboard and via `POST /api/v1/checkouts`).
