...
For a **single hosted payment page** across Argentina, Brazil, Chile, and Bolivia, use **[Hosted checkout](/checkouts/introduction)** (`POST /api/v1/checkouts`) instead of country-specific inbound APIs where that fits your product.
