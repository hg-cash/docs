...
| **BO** | Optional `description`; payer scans QR on hosted page |
...
- Response may include **`qrCode`** (base64 image) for the payer to scan on the hosted page.
- Optional **`description`** on create (max 60 characters).
